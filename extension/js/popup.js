    ...
    xhttp.onreadystatechange = function() {
         if (this.readyState == 4 && this.status == 200) {
            ...
            if (data["fake_news"] >= 0.5) {
                ...
                stats.innerHTML += " is completely ".bold().fontcolor("green");
                stats.innerHTML += "<img src=\"/icons/legit.jpg\"/>";
            }
            console.log(data['fake_news'])
...
function add_bar(percent) {
  var data = [1 * 100, (percent * 100).toFixed(2)]; // here are the data values; v1 = total, v2 = current value
